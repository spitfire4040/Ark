...
int main()
{
	...
	for (i = 1; i < 4; i++)
	{
		...
		cout << "trace: day-" << num << endl;

		// set file name
		inFileName1 = "/home/jay/Ark/Output/day-" + num + "/unique-traces.txt"; // unique_trace
		inFileName2 = "/home/jay/Ark/Output/day-" + num + "/all-traces.txt"; // all_trace
		outFileName = "/home/jay/Ark/Output/day-" + num + "/traceCount.txt"; // trace_count
